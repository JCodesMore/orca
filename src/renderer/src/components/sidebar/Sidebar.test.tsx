...
// Why: the fork mounts SpaceTabs inside Sidebar; mock it like the other heavy
// children so this appearance-focused test doesn't pull in its tooltip tree.
vi.mock('./SpaceTabs', () => ({
  default: () => <div data-testid="space-tabs" />
}))
